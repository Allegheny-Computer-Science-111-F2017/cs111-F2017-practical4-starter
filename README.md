...
# cs111-F2017-practical4-solution

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the solution for Practical 4 in Computer Science 111. Since
...
* The `MadLibs` program must:
  ...
  * Read in multiple numbers and words from a file
  * Display those numbers and words in the form of a silly story
...
that will differ from the instructor's version of `MadLibs`. As long as your
...
purpose of the `MadLibs` program is to display a silly story using words and
...
Starter](https://github.com/Allegheny-Computer-Science-111-F2017/cs111-F2017-practical4-starter)
